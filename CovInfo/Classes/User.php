...
class User extends Person implements IUser
{
    ...
    public static function createNewUser($emailAddress,$firstName,$middleName,$lastName,$nicNo,$dob,$gender,$district,$province,$mohDiv,$address,$phoneNo,$bloodType,$medicalRemarks,$userType){
             ...
             $sql = "INSERT INTO `user` (`account_id`, `password`, `email_address`, `first_name`, `middle_name`, `last_name`, `nic_number`, `birth_day`,`o_birth_day`, `gender_id`, `district_id`, `province_id`, `moh_division_id`, `address`, `phone_number`, `user_type_id`, `status_id`, `vaccine_status_id`, `blood_type_id`, `account_type`, `medical_remarks`) 
VALUES (:account_id, '0a7e3fd172f123df0bed7a8fafa11f75', :email_address, :first_name, :middle_name, :last_name, :nic_number, :birth_day,:o_birth_day, :gender_id, :district_id, :province_id, :moh_division_id, :address, :phone_number, :user_type_id, 1, 1, :blood_type_id, 1, :medical_remarks)";
             ...
             if($userType != 1){
                 ...
                 $adStmt->execute(array("user_id"=>$uid));
             }
             return $row["user_id"];
    }
