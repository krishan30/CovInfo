...
if(isset($_SESSION["ep-needUpdate"])){
    /*$sql = "UPDATE user SET email_address=:email_address,first_name=:first_name, middle_name=:middle_name,
                last_name=:last_name, nic_number=:nic_number, birth_day=:birth_day, gender_id=:gender_id, district_id=:district_id, province_id =: province_id, moh_division_id=:moh_division_id,
                address=:address, phone_number=:phone_number, blood_type_id=:blood_type_id, medical_remarks=:medical_remarks WHERE user_id=:user_id";
    $stmt = $connection->prepare($sql);
    $stmt->execute(array(":email_address"=>$_SESSION["ep-email"],"first_name"=>$_SESSION["ep-firstName"],"middle_name"=>$_SESSION["ep-middleName"],
