...
<br><br>
<p class="h-4 m-3 p-3 row justify-content-center border border-2 rounded-3 boxy" style="font-weight: bold">Edit Profile</p>
<br>
<div class="container justify-content-center">
    <div class="container boxy-blue text-center">
        <div class="h1">This is Edit profile page</div>
        <?php if($administratorMode){?>
            <h1>Admin</h1>
        <?php }else{ ?>
            <h1>Public</h1>
        <?php } ?>
