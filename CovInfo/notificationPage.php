...
<div class="container bg-white justify-content-center boxy-blue ">
    <div class="row justify-content-center p-3 mb-3 fs-3 text-center fw-bold ">
        <h3 >Notifications </h3>
    </div>
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="Unread" aria-selected="true">UnRead</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="Read" aria-selected="false">Read</a>
        </li>
    </ul>
        ...
        <div class=" row tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="d-flex align-items-start">
                <div class="col-4 border-right-1">
                    <div class="nav flex-column nav-tabs me-3 d-grid gap-2 col float-left" id="v-pills-tab" role="tablist" aria-orientation="vertical" style='overflow-y:auto; width:400px;max-height:400px;'>
                        <?php
                        if(!$notifications){
                ...
                <div class="col ms-5">
                    <div class="tab-content bg-light " id="v-pills-tabContent">
                        <div class="tab-pane fade show active border border-secondary" id="default" role="tabpanel" aria-labelledby="v-pills-home-tab" style="align-items: center; text-align:center;">
                            <small class="text-muted">Select a notification to view.</small>
                        </div>

                        <div class="tab-pane fade border border-secondary mb-3" id="Covid-19-Quarantine-Alert" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <p>
                        ...
                        <div class="tab-pane fade border border-secondary mb-3" id="Covid-19-Infection-Alert" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <p>
                        ...
                        <div class="tab-pane fade border border-secondary mb-3" id="Covid-19-Quarantine-Extend-Alert" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                            <p>
                        ...
                        <div class="tab-pane fade border border-secondary mb-3" id="Covid-19-Quarantine-Ended-Alert" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                            <p>
                        ...
                        <div class="tab-pane fade border border-secondary mb-3" id="Covid-19-Patient-Release-Alert" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                            <p>
                        ...
                        <div class="tab-pane fade border border-secondary mb-3" id="Covid-19-Vaccination-Registration-Complete" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                            <p>
                    ...
                    <div class="col-4 border-right-1">
                        <div class="nav flex-column nav-tabs me-3 d-grid gap-2 col float-left" id="v-pills-tab" role="tablist" aria-orientation="vertical" style='overflow-y:auto; width:400px;max-height:400px;'>
                            ...
                            foreach ($oldNotifications as $index => $notification) {
                                ...
                                $notificationReceivedDate = $notification->getReceivedDate();
                                $link=str_replace(' ', '-', $notificationMessage);
                                echo(" <button  class='nav-link border border-secondary ' id='v-pills-home-tab' data-bs-toggle='tab' data-bs-target='#$link' type='button' role='tab' aria-controls='v-pills-home' aria-selected='true' value='$notificationID'><i class='bi bi-chat-fill'></i>
                        <div >
                         $notificationMessage
                        </div> 
                        <div style='display: inline-flex'>
