...
<head>
    <meta charset="UTF-8">
    <title>CovInfo | Create User</title>
            ...
            <div class="card h-100 boxy-blue">
                <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" id="moh"  required name="moh">
                                    ...
                                    while ($row = $mohDivisionList->fetch(PDO::FETCH_ASSOC)){?>
                                        <option value="<?php echo $row["moh_division_id"] ?>" ><?php echo $row["moh_name"] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row gutters">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="text-end">
                                <a href="index.php"><button type="button" id="cancel" name="cancel" class="btn btn-outline-secondary mx-2">Cancel</button></a>
                                <button type="submit" id="register" name="register" class="btn btn-outline-primary mx-2">Register</button>
                            </div>
                        </div>
                    </div>
                </div>
