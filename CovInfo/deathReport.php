<?php
    ...
    if(isset($_POST["death-location"]) && isset($_POST["register"])){
        ...
        $stmt->execute(array('user_id'=>$_POST['user_id'],'medical_officer_id'=>$medical_officer_id,'death_date'=>$_POST['death-date'],'death_location'=>$_POST["death-location"],'death_cause'=>$_POST["death-cause"]));
        $sql = "UPDATE user set status_id=4  where user_id=:user_id";
        $stmt=$connection->prepare($sql);
...
<body>
    ...
    <div class=" container d-grid gap-3 bg-white p-3">
        <div class="row ">
            <p class=" fs-5 text-center fw-bold">Death Reporting Form</p>
        </div>
    ...
    <div class=" container d-grid gap-3 bg-white p-3">
        <div class="row border-bottom border-primary ">
            <p class="fs-5 text-justify">Circumstances of Death</p>
        </div>
        <form action="deathReport.php" method="post">
            <div class="row">
                <div class="col-sm">
                ...
                <div class="col-sm">
                    ...
                    <input type="text" name="death-location" id="death-location" class="form-control">
                </div>
            </div>
            <div class="row">
                <label class="form-label" for="death-date">Date of Death</label>
                <div class="col-sm-3">
                <input class="form-control" type="date" name="death-date" id="death-date">
                </div>
            ...
            <div class="row">
                ...
                <div class="col">
                <textarea class="form-control" id="death-cause" name = "death-cause" rows="3"></textarea>
                </div>
